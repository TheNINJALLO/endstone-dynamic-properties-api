...
class ExactEndstoneDependencies(ConanFile):
    ...
    def generate(self):
        ...
        toolchain.variables["ENDSTONE_CONAN_BDS_BUILD"] = str(self.options.bds_build)
        toolchain.preprocessor_definitions["ENTT_SPARSE_PAGE"] = 2048
        toolchain.preprocessor_definitions["ENTT_NO_MIXIN"] = "1"
        toolchain.generate()
